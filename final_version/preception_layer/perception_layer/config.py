...
DEFAULT_CONTEXT_PATH = Path("/Users/ken/MM/Pipeline/final_version/preception_layer/artifacts/context.md")
DEFAULT_RAG_SEARCH_RECORD_PATH = Path("/Users/ken/MM/Pipeline/final_version/preception_layer/artifacts/rag_search_record.md")
DEFAULT_LLM_CHAT_RECORD_PATH = Path("/Users/ken/MM/Pipeline/final_version/preception_layer/artifacts/llm_chat_record.jsonl")
DEFAULT_OUTPUT_PATH = Path("/Users/ken/MM/Pipeline/final_version/preception_layer/artifacts/slots.jsonl")
DEFAULT_REQUEST_TIMEOUT = 180.0
DEFAULT_GROUNDING_QUERY_WORKERS = 4
DEFAULT_SLOT_PLANNER_WORKERS = 4
...
class PipelineConfig:
    ...
    grounding_query_workers: int = DEFAULT_GROUNDING_QUERY_WORKERS
    slot_planner_workers: int = DEFAULT_SLOT_PLANNER_WORKERS
    enable_ontology_inference: bool = False
    emit_debug_context_sections: bool = False
    write_rag_search_record: bool = True
    write_llm_chat_record: bool = True
    ...
    def from_env(cls) -> "PipelineConfig":
        ...
        return cls(
            ...
            grounding_query_workers=max(
                1,
                int(os.getenv("PERCEPTION_GROUNDING_QUERY_WORKERS", str(DEFAULT_GROUNDING_QUERY_WORKERS))),
            ),
            slot_planner_workers=max(
                1,
                int(os.getenv("PERCEPTION_SLOT_PLANNER_WORKERS", str(DEFAULT_SLOT_PLANNER_WORKERS))),
            ),
            enable_ontology_inference=_env_bool("PERCEPTION_ENABLE_ONTOLOGY_INFERENCE", False),
            emit_debug_context_sections=_env_bool("PERCEPTION_EMIT_DEBUG_CONTEXT_SECTIONS", False),
            write_rag_search_record=_env_bool("PERCEPTION_WRITE_RAG_SEARCH_RECORD", True),
            write_llm_chat_record=_env_bool("PERCEPTION_WRITE_LLM_CHAT_RECORD", True),
        )
