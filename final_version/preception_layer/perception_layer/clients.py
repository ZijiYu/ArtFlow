...
try:
    ...
    APIConnectionError = APITimeoutError = InternalServerError = RateLimitError = Exception  # type: ignore[assignment]
        ...
        *,
        ...
        for attempt in range(1, 5):
            try:
                ...
                print(
                    f"[perception_request] type=llm_retry model={self._model} "
                    f"attempt={attempt}/4 wait_s={wait_s:.1f} "
...
class HttpRagClient:
    ...
    def clone(self) -> "HttpRagClient":
        return HttpRagClient(self._endpoint)
        ...
        *,
        ...
        req = request.Request(
            ...
            headers={
                ...
                # Force each retrieval to use an isolated request context.
                "Connection": "close",
